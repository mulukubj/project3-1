...
x1<-data.frame("Centroid"=c(centroid_50_all,centroid_100_all),"GLM"=c(glm_50_all,glm_100_all),"NeuralNet"=c(nn_50_all,nn_100_all))
rownames(x1) <- c("50 genes","100 genes")


x3<-data.frame("Centroid"=c(centroid_50_all),"GLM"=c(glm_50_all), "NeuralNet"=c(nn_50_all))
rownames(x3) <- c("50 genes")
kable(x3)
